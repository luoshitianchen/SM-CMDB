...
#   ./scripts/restore.sh /backup/sm-cmdb/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-cmdb/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
...
SERVICE_NAME="sm-cmdb"
DB_HOST="${DB_HOST:-postgres}"
DB_PORT="${DB_PORT:-5432}"
DB_NAME="${DB_NAME:-sm_cmdb_db}"
